                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex-1">
                            ...
                            <p class="text-blue-100 text-lg mb-4">
                                Kelola pembayaran SPP Anda dengan mudah dan aman
                            </p>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <div
                                class="w-12 h-12 {{ $unpaidBills->count() > 0 ? 'bg-red-100' : 'bg-green-100' }} rounded-lg flex items-center justify-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p
                                class="text-2xl font-bold {{ $unpaidBills->count() > 0 ? 'text-red-600' : 'text-green-600' }}">
                                {{ $unpaidBills->count() }}
                            </p>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-green-600">{{ $paidBills->count() }}</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <a href="{{ route('user.bills') }}"
                        class="group relative bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 hover:from-blue-100 hover:to-blue-200 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg">
                        <div
                    ...
                    <a href="{{ route('profile.edit') }}"
                        class="group relative bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 hover:from-green-100 hover:to-green-200 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg">
                        <div
                            class="absolute top-4 right-4 opacity-10 group-hover:opacity-20 transition-opacity duration-300">
                    ...
                    <!-- Riwayat Pembayaran -->
                    <a href="#"
                        class="group relative bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 hover:from-purple-100 hover:to-purple-200 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg">
                        <div
                            class="absolute top-4 right-4 opacity-10 group-hover:opacity-20 transition-opacity duration-300">
                    ...
                    <!-- Support -->
                    <a href="#"
                        class="group relative bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-6 hover:from-orange-100 hover:to-orange-200 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg">
                        <div
                            class="absolute top-4 right-4 opacity-10 group-hover:opacity-20 transition-opacity duration-300">
                ...
                <div class="p-6">
                    @if ($recentBills->count() > 0)
                            ...
                            @foreach ($recentBills as $bill)
                                <div
                                    ...
                                    <div class="text-right">
                                        <div class="font-bold text-gray-900 mb-1">{{ $bill->formatted_amount }}</div>
                                        @if ($bill->status === 'paid')
                                            <span
                        ...
                        <div class="mt-6 text-center">
                            <a href="{{ route('user.bills') }}"
                                class="inline-flex items-center px-6 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors duration-200">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-3 mb-4">
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="text-sm text-gray-700">Virtual Account</span>
                        </div>
                        <div class="flex items-center">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm text-gray-700">admin@sekolah.com</span>
                        </div>
                        <div class="flex items-center">
                            <div class="w-8 h-8 bg-green-100 rounded flex items-center justify-center mr-3">
                                <i class="fas fa-phone text-green-600 text-xs"></i>
                            </div>
                            <span class="text-sm text-gray-700">(021) 1234-5678</span>
                        </div>
                        <div class="flex items-center">
                            <div class="w-8 h-8 bg-yellow-100 rounded flex items-center justify-center mr-3">
                                <i class="fas fa-clock text-yellow-600 text-xs"></i>
                            </div>
                            <span class="text-sm text-gray-700">Senin - Jumat, 08:00 - 17:00</span>
                        </div>
                    </div>
                </div>
            </div>
